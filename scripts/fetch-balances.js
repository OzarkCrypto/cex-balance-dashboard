...
async function main() {
  ...
  if (process.env.BINANCE_API_KEY && process.env.BINANCE_API_SECRET) {
    try {
      ...
      console.log('✓ Binance:', results.binance.length, 'assets');
    } catch (e) {
  ...
  if (process.env.BYBIT_API_KEY && process.env.BYBIT_API_SECRET) {
    try {
      ...
      console.log('✓ Bybit:', results.bybit.length, 'assets');
    } catch (e) {
  ...
  if (process.env.OKX_API_KEY && process.env.OKX_API_SECRET && process.env.OKX_PASSPHRASE) {
    try {
      ...
      console.log('✓ OKX:', results.okx.length, 'assets');
    } catch (e) {
      errors.okx = e.message;
      console.log('✗ OKX:', e.message);
    }
  }
  ...
  if (process.env.KUCOIN_API_KEY && process.env.KUCOIN_API_SECRET && process.env.KUCOIN_PASSPHRASE) {
    try {
      ...
      console.log('✓ KuCoin:', results.kucoin.length, 'assets');
    } catch (e) {
  ...
  if (process.env.KRAKEN_API_KEY && process.env.KRAKEN_API_SECRET) {
    try {
      ...
      console.log('✓ Kraken:', results.kraken.length, 'assets');
    } catch (e) {
      errors.kraken = e.message;
      console.log('✗ Kraken:', e.message);
    }
  }
  ...
  if (process.env.ZOOMEX_API_KEY && process.env.ZOOMEX_API_SECRET) {
    try {
      ...
      console.log('✓ Zoomex:', results.zoomex.length, 'assets');
    } catch (e) {
      errors.zoomex = e.message;
      console.log('✗ Zoomex:', e.message);
    }
  }
